...
def upload_image():
    ...
    if image_valid:
        print("Imagen válida, activando servo")
        return jsonify({'message': 'La persona conocida está en la imagen.', 'activate_servo': True}), 200
    else:
        print("Imagen no válida")
        return jsonify({'message': 'La persona conocida NO está en la imagen.', 'activate_servo': False}), 200
